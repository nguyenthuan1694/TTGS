...
@section('content')
    ...
    <section>
        <div class="container vrsg-cart">
            <div class="row">
                <div class="col-lg-8 col-sm-7 col-xs-12 p-0">
                   <div class="cart--info_customer">
                        <form name="checkout" action="{{ route('cart.postCheckout') }}" method="post">
                            ...
                            <div class="section--default section--default-custom">
                                ...
                                <!-- <div class="form-group">
                                    <select id="province" name="province_code" class="col-md-4 form-control custom-select">
                                ...
                                <div class="form-group">
                                    <select id="district" name="district_code" class="col-md-4 form-control custom-select">
                            ...
                            <div class="p-0 section--default">
                                ...
                                <div class="wrap-apply-promo">
                                    ...
                                    <div class="shopping-total">
                                        <p>Tổng tiền <span class="float-right">{{ number_format($subTotal, 0) }} VNĐ</span></p>
                                        ...
                                        <p class="total">Thanh toán <span style="font-size: 14px" class="price float-right">{{ number_format($total, 0) }} VNĐ</span></p>
                                    </div>
                                </div>
