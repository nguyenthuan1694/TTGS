...
@section('content')
    ...
    <nav class="hk-breadcrumb" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-light bg-transparent">
            ...
            <li class="breadcrumb-item"><a href="{{ route('parentsNotes.index') }}">Introduce</a></li>
    ...
    <div class="container-fluid px-xxl-65 px-xl-20">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title text-uppercase"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Edit a new parentsNotes</h4>
        </div>
        <!-- /Title -->
        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    <h5 class="hk-sec-title text-uppercase">parents_note</h5>
                    <div class="row">
                        <div class="col-sm">
                        <form class="needs-validation" novalidate action="{{ route('parentsNotes.update', ['parentsNote' => $parentsNote->id]) }}" method="post" enctype="multipart/form-data">
                                @method('PUT')
                                {{ csrf_field() }}
                                <input type="hidden" name="id" value="{{ $parentsNote->id }}">
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        <div class="col-md">
                                            <label for="title">Title</label>
                                            <input id="title" name="title" type="text" class="form-control" value="{{ $parentsNote->title }}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="col-md">
                                            ...
                                            <input id="slug" name="slug" type="text" class="form-control" value="{{ $parentsNote->slug }}" required>
                                            <small class="form-text text-muted">*Required</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <div class="col-md">
                                            ...
                                            <textarea class="tinymce" rows="3" name="description">{{ $parentsNote->description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
