...
@section('content')
    ...
    <nav class="hk-breadcrumb" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-light bg-transparent">
            ...
            <li class="breadcrumb-item"><a href="{{ route('news.index') }}">Introduce</a></li>
    ...
    <div class="container-fluid px-xxl-65 px-xl-20">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title text-uppercase"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Edit a new Introduce</h4>
        </div>
        <!-- /Title -->
        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <form class="needs-validation" novalidate action="{{ route('introduces.update', ['introduce' => $introduce->id]) }}" method="post" enctype="multipart/form-data">
                                @method('PUT')
                                {{ csrf_field() }}
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        <div class="col-md">
                                            ...
                                            <input id="title" name="title" type="text" class="form-control" value="{{ $introduce->title }}" required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="col-md">
                                            ...
                                            <input id="slug" name="slug" type="text" class="form-control" value="{{ $introduce->slug }}" required>
                                            <small class="form-text text-muted">*Required</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md">
                                        ...
                                        <textarea class="tinymce" rows="3" name="long_description">{{ $introduce->long_description }}</textarea>
                                        </div>
                                    </div>
                                </div>

                                <div class="float-right">
                                    <a href="{{ route('introduces.index') }}" class="btn btn-light">CANCEL</a>
